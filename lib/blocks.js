...
export function createBlocks(auth) {
  ...
  /** GET the full (unpaginated) hides list. Tolerant of a missing/empty envelope
   * (like listBlocks) so a benign shape can't abort a whole reconcile that calls
   * this uncaught. @returns {Promise<Array>} */
