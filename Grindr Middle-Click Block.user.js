...
(function () {
  ...
  const BLOCK_CONFIRM_QUIET_MS = 10 * 60_000;
  ...
  function saveConfirmedBlocks() {
    try { localStorage.setItem(BLOCK_CONFIRMED_STORAGE_KEY, JSON.stringify([...blockConfirmedIds])); return true; }
    catch (e) { logWarn(`${LOG} saveConfirmedBlocks failed:`, e); return false; }
  }
  ...
  window.__grindrBlock_blockTiers = function () {
    return { pending: pendingBlockIds(), confirmed: [...blockConfirmedIds], quietMs: BLOCK_CONFIRM_QUIET_MS };
  };
