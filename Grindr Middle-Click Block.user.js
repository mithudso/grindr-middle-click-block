...
(function () {
  ...
  function buildHar() {
    return {
      log: {
        version: '1.2',
        creator: { name: 'GrindrBlock userscript', version: '0.37.0' },
  ...
  function enforceAllBlocked() {
    ...
    diagEvent('sweep', { imgs: imgs.length, matched: swept, hidden: collapsed, blocked: blockedSet.size, hidden_list: hiddenProfileIds.size });
  }
  ...
  function startDiagRecording() {
    ...
    diagEvent('recording-started', { url: location.href, version: '0.37.0' });
