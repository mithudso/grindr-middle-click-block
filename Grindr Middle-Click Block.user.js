...
(function () {
  ...
  async function drainTick() {
    ...
    if (!serverBlocksKnown) {
      logTrace(`${LOG} auto-drain holding: no snapshot of Grindr's block list yet, so every entry would look unupgraded. Waiting for the first reconcile.`);
      return;
    }
    if (drainBudgetSpent()) {
  ...
  try {
    if (typeof module === 'object' && module && module.exports) {
      module.exports = {
        ...
        queueInsertIndex, nextRunnableIndex, parseServerBlocksSnapshot,
